/* ============================================================
Dótir 2 — modules/musica/musica.js
· El botón ⏹ Detener es global (montado en core/audio.js)
y persiste en toda la app — este módulo ya no lo gestiona.
============================================================ */
...
_detenerAnimacion();
// El botón global ⏹ lo gestiona AudioManager, no tocamos #modulo-acciones
}
